...
describe('exported types', () => {
  describe('ActivationInput', () => {
    ...
    test('should type steps toolCalls toolName as string', () => {
      type Step = NonNullable<ActivationInput<typeof TOOLS>['steps']>[number];
    ...
    test('should have context as optional', () => {
      type Input = ActivationInput<typeof TOOLS, UIMessage, { isAdmin: boolean }>;
